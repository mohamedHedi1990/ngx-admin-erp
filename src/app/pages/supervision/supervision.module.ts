...
@NgModule({
  declarations: [GlobalSupervisionComponent, StatusCardComponent, EtatGlobalTreserorieComponent, EtatNonEngageComponent, RapprochementBancaireComponent, EtatEngageComponent],
  imports: [
    CommonModule,
